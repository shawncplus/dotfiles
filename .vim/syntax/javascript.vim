...
syntax region  javaScriptRegexpString   start=+/\(\*\|/\)\@!+ skip=+\\\\\|\\/+ end=+/[gim]\{,3}+ contains=javaScriptSpecial,@htmlPreproc oneline contained
syntax match   javaScriptNumber         /\<-\=\d\+L\=\>\|\<0[xX]\x\+\>/
syntax match   javaScriptFloat          /\<-\=\%(\d\+\.\d\+\|\d\+\.\|\.\d\+\)\%([eE][+-]\=\d\+\)\=\>/
syntax match   javaScriptLabel          /\(?\s*\)\@<!\<\w\+\(\s*:\)\@=/

"syn region javaScriptTernaryRegion matchgroup=javaScriptOperator start=/?/ end=/::\@!/ transparent keepend extend display contained matchgroup=Error end=/[;)\]}]/
...
"if exists("javascript_enable_domhtmlcss")
    ...
    syntax match javaScriptDomElemFuncs     contained /\%(insertBefore\|createElement\|replaceChild\|removeChild\|appendChild\|hasChildNodes\|cloneNode\|normalize\|isSupported\|hasAttributes\|getAttribute\|setAttribute\|removeAttribute\|getAttributeNode\|setAttributeNode\|removeAttributeNode\|getElementsByTagName\|getAttributeNS\|setAttributeNS\|removeAttributeNS\|getAttributeNodeNS\|setAttributeNodeNS\|getElementsByTagNameNS\|hasAttribute\|hasAttributeNS\)\>/ nextgroup=javaScriptParen skipwhite
    " HTML things
    ...
    " Highlight ways
    syntax match javaScriptDotNotation      "\." nextgroup=javaScriptPrototype,javaScriptDomElemAttrs,javaScriptDomElemFuncs,javaScriptHtmlElemAttrs,javaScriptHtmlElemFuncs display
    syntax match javaScriptDotNotation      "\.style\." nextgroup=javaScriptCssStyles

    syntax match javaScriptFirebug          "\<console" nextgroup=javaScriptDotNotation
...
"" Code blocks
syntax cluster javaScriptAll       contains=javaScriptComment,javaScriptLineComment,javaScriptDocComment,javaScriptStringD,javaScriptStringS,javaScriptRegexpString,javaScriptNumber,javaScriptFloat,javaScriptLabel,javaScriptSource,javaScriptType,javaScriptOperator,javaScriptBoolean,javaScriptNull,javaScriptFunction,javaScriptConditional,javaScriptRepeat,javaScriptBranch,javaScriptStatement,javaScriptGlobalObjects,javaScriptExceptions,javaScriptFutureKeys,javaScriptDomErrNo,javaScriptDomNodeConsts,javaScriptHtmlEvents,javaScriptDotNotation,javaScriptCompare,javaScriptOpAssign,javaScriptTernaryRegion,javaScriptFirebug
syntax region  javaScriptBracket   matchgroup=javaScriptBracket transparent start="\[" end="\]" contains=@javaScriptAll,javaScriptParensErrB,javaScriptParensErrC,javaScriptBracket,javaScriptParen,javaScriptBlock,@htmlPreproc
syntax region  javaScriptParen     matchgroup=javaScriptParen   transparent start="("  end=")"  contains=@javaScriptAll,javaScriptParensErrA,javaScriptParensErrC,javaScriptParen,javaScriptBracket,javaScriptBlock,@htmlPreproc,@javaScriptRegexpString
...
if exists("b:javascript_fold")
    ...
    syntax match   javaScriptOpAssign       /=\@<!=/ skipwhite skipempty
    syntax match   javaScriptOpAssign       /+=/  skipwhite skipempty
    syntax match   javaScriptOpAssign       /-=/  skipwhite skipempty
    syntax match   javaScriptOpAssign       /[-+*/%^&|]=/ skipwhite skipempty

    syntax match   javaScriptCompare         /[%^|*!~]/
    syntax match   javaScriptCompare         /\/[*/]\@!/
    syntax match   javaScriptCompare         /&&/
    syntax match   javaScriptCompare         /||/
    syntax match   javaScriptCompare         />>/
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  hi javaScriptFirebug guifg=#FF0000 font=Consolas:h11:b:cANSI
  ...
  HiLink javaScriptDotNotation          javaScriptOperator
  ...
  HiLink javaScriptCompare              Operator
  delcommand HiLink
endif
