...
syn match   htmlTagN     contained +<\s*[-a-zA-Z0-9]\++hs=s+1 contains=htmlTagName,htmlSpecialTagName,@htmlTagNameCluster,polymerTagName
syn match   htmlTagN     contained +</\s*[-a-zA-Z0-9]\++hs=s+2 contains=htmlTagName,htmlSpecialTagName,@htmlTagNameCluster,polymerTagName
...
syn match htmlTagName contained "\<\([-a-z]\+\)\+\>"

syn match polymerTagName contained "\<\(neon\|google\|platinum\|paper\|iron\|dom-module\)\(-[a-z]\+\)*\>"
hi polymerTagName term=bold cterm=bold ctermfg=161
hi polymerArg cterm=none ctermfg=161
...
syn match   htmlArg contained "\<\([-a-z]\+\)="me=e-1
