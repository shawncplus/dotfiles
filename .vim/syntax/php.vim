...
" Type
syn keyword phpType bool[ean] int[eger] real double float string array object contained
syn match phpNull "\<\%(null\)\>"
...
syn match phpVarSelector  "\$"  contained display conceal
...
syn cluster phpClConst  contains=phpFunctions,phpIdentifier,phpConditional,phpRepeat,phpStatement,phpOperator,phpRelation,phpStringSingle,phpStringDouble,phpBacktick,phpNumber,phpFloat,phpKeyword,phpType,phpBoolean,phpStructure,phpMethodsVar,phpConstant,phpCoreConstant,phpException,phpNull
...
syntax match  phpDocCustomTags  /\* @[^*]*\(\s\+\)/hs=s+2 containedin=phpComment 
syntax match  phpDocAnnoArgument "(.*)" containedin=phpDocCustomTags contains=phpAnnoStringDouble,phpAnnoStringSingle
syn region  phpAnnoStringDouble matchgroup=None start=+"+ skip=+\\\\\|\\"+ end=+"+  contains=@phpAddStrings,phpBackslashSequences,phpBackslashDoubleQuote,@phpInterpDouble contained keepend
syn region  phpAnnoStringSingle matchgroup=None start=+'+ skip=+\\\\\|\\'+ end=+'+  contains=@phpAddStrings,phpBackslashSingleQuote contained keepend
syntax region phpDocTags  start="{@\(example\|id\|internal\|inheritdoc\|link\|source\|toc\|tutorial\)" end="}" containedin=phpComment
syntax match  phpDocTags  /\* @\(abstract\|access\|author\|category\|copyright\|deprecated\|example\|final\|global\|ignore\|internal\|license\|link\|method\|name\|package\|param\|property\|return\|see\|since\|static\|staticvar\|subpackage\|tutorial\|uses\|var\|version\|contributor\|modified\|filename\|description\|filesource\|throws\)\(\s\+\)\?/hs=s+2 containedin=phpComment
...
if version >= 508 || !exists("did_php_syn_inits")
  ...
  HiLink   phpDocCustomTags Todo
  HiLink   phpAnnoStringDouble String
  HiLink   phpAnnoStringSingle String
